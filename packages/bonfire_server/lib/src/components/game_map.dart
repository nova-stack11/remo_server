...
import 'package:bonfire_server/src/components/game_npc.dart';
...
import 'package:bonfire_server/src/util/game_map_object_properties.dart';
...
abstract class GameMap extends GameComponent {
  ...
  GameVector getTilePosition({
    ...
    final yTilePosition = yTileCount * map.tileHeight!;
    return GameVector(
      x: xTilePosition,
